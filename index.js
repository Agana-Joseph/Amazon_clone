...
const SPORTS_NEWS = `https://newsapi.org/v2/top-headlines?country=${COUNTRY_CODE}&category=sports&apiKey=`;
const ENTERTAINMENT_NEWS = `https://newsapi.org/v2/top-headlines?country=${COUNTRY_CODE}&category=entertainment&apiKey=`;
const TECHNOLOGY_NEWS = `https://newsapi.org/v2/top-headlines?country=${COUNTRY_CODE}&category=technology&pageSize=8&apiKey=`;
